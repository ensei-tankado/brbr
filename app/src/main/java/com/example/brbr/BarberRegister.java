...
public class BarberRegister extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.barber_register);
    ...
    private void writeNewUser(String username, String fullname, String mobile, String uid, String place) {
        User user = new User(username, fullname, mobile, false, "barber", place);
                ...
                mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Intent intent = new Intent(BarberRegister.this, BarberLogin.class);
